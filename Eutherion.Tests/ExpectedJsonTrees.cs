...
namespace Eutherion.Text.Json.Tests
{
    ...
    public static class ExpectedJsonTrees
    {
        ...
        public static readonly List<(string, ExpectedJsonTree)> TestParseTrees = new()
        {
        ...
        public static readonly List<(string, ExpectedJsonTree, JsonErrorCode[])> TestParseTreesWithErrors = new()
        {
            ("/*", new ExpectedJsonTree<JsonMultiValueSyntax>
            {
                new ExpectedJsonTree<JsonValueWithBackgroundSyntax>
